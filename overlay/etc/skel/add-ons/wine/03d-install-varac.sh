...
# Check for VarAC installer in Downloads before running winetricks
shopt -s nullglob
...
echo -e "${YELLOW}In the 'Select components to install' dialog, uncheck:${NC}"
echo -e "  ${WHITE}• Start Menu Shortcuts${NC}"
echo -e "  ${WHITE}• Download VARA modem${NC}"
echo -e "${YELLOW}Press Enter to launch the VarAC installer...${NC}"
read -r
